...
export default async function ({ PRIVATE_GLOBAL }) {
	const [
		...
		"../../src/utils/index.js",
		"../../src/utils/constant",
		"../../src/utils/scroll-bar",
		"../../src/utils/request-animation-timeout",
		"../../src/utils/event-key-codes",
		"../../src/utils/hooks-manager",
		"../../src/utils/mouse-event",
		"../../src/mixins/emitter",
		"./util/constant",
		"./colgroup",
		"./header",
