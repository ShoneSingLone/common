<template>
  <div
    :class="cpt_container_class"
    :style="cpt_container_style"
  >
    <textarea
    ...
    computed: {
      ...
      cpt_container_class() {
        ...
        result = {
          ...
          [Vue._X_TABLE_EASY_UTILS.clsName('edit-input-container-show')]: displayTextarea && !overflowViewport
        };
      ...
      cpt_container_style() {
        ...
        const { displayTextarea, overflowViewport, textareaRect, cpt_current_column: column } = this;
            ...
            */
            if (hasRightFixedColumn) {
              if (column && !column.fixed) {
                const rightFixedTotalWidth = Vue._X_TABLE_EASY_UTILS.getFixedTotalWidthByColumnKey({
                  colgroups,
                  colKey: column.key,
