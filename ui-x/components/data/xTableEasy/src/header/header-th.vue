  ...
  methods: {
    ...
    getTheadThClass({ fixed }) {
      let result = {
        ...
        [`${Vue._X_TABLE_EASY_CLS_NAME}last-left-fixed-column`]: this.cpt_is_last_left_fixed_column,
        [`${Vue._X_TABLE_EASY_CLS_NAME}first-right-fixed-column`]: this.cpt_is_first_right_fixed_column,
      ...
      if (cellSelectionRangeData) {
        ...
        if (!Vue._X_TABLE_EASY_UTILS.isEmptyValue(leftColKey)) {
          ...
          if (leftColKey === rightColKey) {
            ...
            indicatorColKeys = Vue._X_TABLE_EASY_UTIL.getColKeysByRangeColKeys({
              colKey1: leftColKey,
              colKey2: rightColKey,
              colgroups
            }) || [];
    ...
    sortChange() {
      ...
      this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE_THADER, Vue._X_TABLE_EASY_EMIT_EVENTS.SORT_CHANGE, {
        currentField,
        sortResult
      });
    },
    ...
    cellClick(e, fn) {
      ...
      this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.HEADER_CELL_CLICK, {
        event: e,
    ...
    cellContextmenu(e, fn) {
      ...
      this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.HEADER_CELL_CONTEXTMENU, {
        event: e,
        column: groupColumnItem
      });
    },
    ...
    cellMouseleave(e, fn) {
      ...
      this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.HEADER_CELL_MOUSELEAVE, {
        event: e,
        column: groupColumnItem
      });
    },
    ...
    cellMousemove(e, fn) {
      ...
      this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.HEADER_CELL_MOUSEMOVE, {
        event: e,
        column: groupColumnItem
      });
    },
    ...
    cellMouseover(e, fn) {
      ...
      this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.HEADER_CELL_MOUSEOVER, {
        event: e,
        column: groupColumnItem
      });
    },
    ...
    cellMousedown(e, fn) {
      ...
      this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.HEADER_CELL_MOUSEDOWN, {
        event: e,
        column: groupColumnItem
      });
    },
