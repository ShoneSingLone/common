    ...
    methods: {
            ...
            if (operationColumn) {
              ...
              if (indicatorRowKeys.indexOf(cpt_current_row_key) > -1) {
                if (isIndicatorActive) {
                  result[Vue._X_TABLE_EASY_UTILS.clsName("cell-indicator-active")] = true;
                } else {
                  result[Vue._X_TABLE_EASY_UTILS.clsName("cell-indicator")] = true;
                }
              }
            }
          }
      ...
      getRenderContent(h) {
        ...
        if (column.ellipsis) {
          ...
          // default true
          const isShowTitle = Vue._X_TABLE_EASY_UTILS.isBoolean(showTitle) ? showTitle : true;
      ...
      cellClick(e, fn) {
        ...
        this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.BODY_CELL_CLICK, {
          event: e,
          rowData,
          column
        });
        ...
        if (expandOption) {
          ...
          if (!trigger || trigger === Vue._X_TABLE_EASY_CONSTANTS.EXPAND_TRIGGER_TYPES.ICON) {
      ...
      cellDblclick(e, fn) {
        ...
        this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.BODY_CELL_DOUBLE_CLICK, {
          event: e,
          rowData,
          column
        });
      ...
      cellContextmenu(e, fn) {
        ...
        this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.BODY_CELL_CONTEXTMENU, {
          event: e,
          rowData,
          column
        });
      ...
      cellMousemove(e, fn) {
        ...
        this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.BODY_CELL_MOUSEMOVE, {
          event: e,
          rowData,
          column
        });
      ...
      cellMouseover(e, fn) {
        ...
        this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.BODY_CELL_MOUSEOVER, {
          event: e,
          rowData,
          column
        });
      ...
      cellMousedown(e, fn) {
        ...
        this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.BODY_CELL_MOUSEDOWN, {
          event: e,
          rowData,
          column
        });
      ...
      cellMouseup(e, fn) {
        ...
        this.dispatch(Vue._X_TABLE_EASY_COMPS_NAME.VE_TABLE, Vue._X_TABLE_EASY_EMIT_EVENTS.BODY_CELL_MOUSEUP, {
          event: e,
          rowData,
          column
        });
