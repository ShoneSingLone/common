...
export default async function ({ PRIVATE_GLOBAL }) {
  ...
  const [
    ...
    _.$importVue("/common/ui-x/components/data/xTableEasy/header/header-filter-custom-content.vue"),
  ...
  // 解构工具函数
  const { getFixedTotalWidthByColumnKey, clsName, getColKeysByRangeColKeys, getColKeysByHeaderColumn } = utilIndex;
