...
`
			...
			/* 【需求】2026-08-11 骨架屏全局样式：shimmer 动画 + 预设布局 */
			$appendStyle(
				"xSkeletonStyle",
...
.x-skeleton__block {
	...
	background-image: linear-gradient(90deg, #e8e8ed 25%, #f5f5f7 50%, #e8e8ed 75%);
...
/* table */
.x-skeleton--table .x-skeleton__header {
	margin-bottom: 12px;
	padding-bottom: 10px;
	border-bottom: 1px solid #eee;
}
.x-skeleton--table .x-skeleton__header .x-skeleton__cell {
	height: 16px;
	margin-right: 1%;
}
.x-skeleton--table .x-skeleton__row {
	margin-bottom: 10px;
}
.x-skeleton--table .x-skeleton__row .x-skeleton__cell {
	margin-right: 1%;
}
/* list */
.x-skeleton__list-item {
	display: flex;
	align-items: center;
	margin-bottom: 14px;
}
.x-skeleton__list-content {
	flex: 1;
	margin-left: 12px;
}
/* card */
...
/* form */
.x-skeleton__form-row {
	display: flex;
	align-items: center;
	margin-bottom: 14px;
	gap: 12px;
}
.x-skeleton__form-row .x-skeleton__cell {
	height: 32px;
}
/* sidebar */
.x-skeleton__sidebar-item {
	margin-bottom: 8px;
	padding: 6px 0;
}
/* detail */
